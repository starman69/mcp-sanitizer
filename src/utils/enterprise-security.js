...
const CONFUSABLE_MAPPINGS = {
  ...
  'а': 'a', 'е': 'e', 'о': 'o', 'р': 'p', 'с': 'c', 'у': 'y', 'х': 'x', 'ь': 'b', 'і': 'i', 'ј': 'j',
  'А': 'A', 'В': 'B', 'Е': 'E', 'К': 'K', 'М': 'M', 'Н': 'H', 'О': 'O', 'Р': 'P', 'С': 'C', 
  'Т': 'T', 'У': 'Y', 'Х': 'X', 'Ѕ': 'S', 'І': 'I', 'Ј': 'J',
  'ѓ': 'r', 'ѕ': 's', 'ќ': 'k', 'ї': 'i', 'љ': 'h', 'њ': 'h', 'ћ': 'h', 'џ': 'u',

  // Greek lookalikes
  'α': 'a', 'β': 'B', 'γ': 'y', 'δ': 'o', 'ε': 'e', 'ζ': 'z', 'η': 'n', 'θ': 'o',
  'ι': 'i', 'κ': 'k', 'λ': 'A', 'μ': 'u', 'ν': 'v', 'ξ': 'E', 'ο': 'o', 'π': 'n',
  'ρ': 'p', 'σ': 'o', 'τ': 't', 'υ': 'u', 'φ': 'o', 'χ': 'x', 'ψ': 'w', 'ω': 'w',
  'Α': 'A', 'Β': 'B', 'Γ': 'r', 'Δ': 'A', 'Ε': 'E', 'Ζ': 'Z', 'Η': 'H', 'Θ': 'O',
  'Ι': 'I', 'Κ': 'K', 'Λ': 'A', 'Μ': 'M', 'Ν': 'N', 'Ξ': 'E', 'Ο': 'O', 'Π': 'n',
  'Ρ': 'P', 'Σ': 'E', 'Τ': 'T', 'Υ': 'Y', 'Φ': 'O', 'Χ': 'X', 'Ψ': 'W', 'Ω': 'O',
  ...
  '𝑎': 'a', '𝑏': 'b', '𝑐': 'c', '𝑑': 'd', '𝑒': 'e', '𝑓': 'f', '𝑔': 'g', '𝒉': 'h', '𝑖': 'i',
...
function detectHomographs(input, options = {}) {
  ...
  const normResult = multiPass ? multiPassNormalization(input) : 
